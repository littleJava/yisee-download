...
'''
parameter passed by the function variable
'''
class YiSee():
    def __init__(self):
        pass
    ...
    def parseNoteContent(self, sections):
        ...
        #    print note.contents 
        #    print note.text 
            self.writeFile(note.txt, 'Z:/LiKuiNote.txt');
        #    break
        #print sections[0]
        return
...
if __name__=="__main__":
    download = YiSee("http://www.yi-see.com/art_8965_6578.html","Z:/LiKuiNote.txt")
    content = download.getPageContent('http://www.yi-see.com/art_8965_6578.html')
    download.parseSections(content)
