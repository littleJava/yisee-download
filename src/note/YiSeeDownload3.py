...
'''
backup for the YiSeeDownload.py.
...
if __name__ == "__main__":
    download = YiSee("http://www.yi-see.com/art_8965_6578.html", "Z:/LiKuiNote1.txt")
    listContent = download.getPageContent(download.url);
    sections = download.parseSections(listContent);
